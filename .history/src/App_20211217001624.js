      ...
      <AuthProvider>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/PersonalHomeServices" element={<PersonalHomeServices></PersonalHomeServices>}></Route>
            <Route path="/CaseStudies" element={<PersonalHomeServices></PersonalHomeServices>}></Route>
            <Route path="/PersonalHomeServices" element={<PersonalHomeServices></PersonalHomeServices>}></Route>
            <Route path="/PersonalHomeServices" element={<PersonalHomeServices></PersonalHomeServices>}></Route>
            <Route path="/PersonalHomeServices" element={<PersonalHomeServices></PersonalHomeServices>}></Route>
            <Route
