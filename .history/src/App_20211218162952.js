...
import { faCheckSquare, faCoffee, faDatabase, faLocationArrow, faTimes } from '@fortawesome/free-solid-svg-icons'

library.add(fab, faCheckSquare, faCoffee, faLocationArrow,faTimes,faDatabase)
