            ...
            {inspired.slice(0,4).map(item => (
              <Col>
                <Card>
                  ...
                  <Card.Body>
                    <p > <span className="subcategory-text">{item.subCategory}</span> <small className="subcategory-text">{item.date}</small> </p>
            ...
            {inspired.slice(4,8).map(item => (
              <Col>
                <Card>
                  <Card.Img variant="top" src={item.imgUrl} />
                  <Card.Body>
                    <Card.Title>{item.subCategory} {item.date}</Card.Title>
                    <Card.Text>
                     {item.title}
                    </Card.Text>
                  </Card.Body>
