...
const FacilityManagement = () => {
  return (
    <div className="container-fluid">
      ...
      <h1 className='text-center mt-5 title-1'>Strategic Facilities Services</h1>
      <p className='text-center'>
        We provide end-to-end strategic facilities management <br /> solutions and
      ...
      <div>
        <h1 className='text-center title-1 '>Soft and Hard Facilities Services</h1>
