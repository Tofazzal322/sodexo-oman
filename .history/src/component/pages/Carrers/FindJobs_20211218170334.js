...
import { faCalendar, faClock, faICursor, faLocationArrow, faMoneyCheck, faSearchLocation } from "@fortawesome/free-solid-svg-icons";
          ...
          <Col md={8}>
            ...
            <div className="mt-3 job-div">
              ...
              <div className="d-flex g-5 w-100 fw-bold mt-3">
                <div className="w-100">
                <p> <FontAwesomeIcon icon={faSearchLocation} /> <span className="ms-2"> Al khuwair, Muscat, OMAN </span> <br /> <FontAwesomeIcon icon={faMoneyCheck} /> <span className="ms-2">OMR  Monthly</span> <br /> <FontAwesomeIcon icon={faClock} /> <span className="ms-2">Fixed Term -Full Time</span> </p>
                
   
              </div>
              <div className="text-align-right w-100 ">
                <p className="">  <span className="me-2">Apply by 22 December, 2021</span> <FontAwesomeIcon icon={faCalendar} /><br /> <span className="me-2">Posted on 10 December, 2021</span> <FontAwesomeIcon icon={faCalendar} /></p>
