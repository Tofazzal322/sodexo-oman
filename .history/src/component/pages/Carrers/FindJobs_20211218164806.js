          ...
          <Col md={8}>
            ...
            <div className="mt-3 job-div">
              ...
              <div className="d-flex g-5 w-100 fw-bold mt-3">
                <div className="w-100">
                <p><FontAwesomeIcon icon="faDatabase" /> Al khuwair, Muscat, OMAN <br /> OMR  Monthly <br /> <FontAwesomeIcon icon="fa-light fa-location-check" /> Fixed Term -Full Time </p>
                
   
              </div>
              <div className="text-align-right w-100 ">
                <p className=""> <FontAwesomeIcon icon={["far", "faCoffee"]} /> Apply by 22 December, 2021 <br /> Posted on 10 December, 2021</p>
