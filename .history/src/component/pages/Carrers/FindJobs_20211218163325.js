          ...
          <Col md={8}>
            ...
            <div className="mt-3 job-div">
              ...
              <div className="d-flex g-5 w-100 fw-bold mt-3">
                <div className="w-100">
                <p><FontAwesomeIcon icon="fa-light fa-location-dot" /> Al khuwair, Muscat, OMAN <br /> OMR  Monthly <br /> <FontAwesomeIcon icon="fa-light fa-location-check" /> Fixed Term -Full Time </p>
