          ...
          <div className="horizontal-line"></div>
            ...
            <div>
                <Row className='container'>
                    ...
                    <Col className='ms-2' xs={12} md={5} lg={5} >

<img  className='ms-5 w-100' src="https://sdxuk-uploads-eu-west-2.s3.amazonaws.com/R0e92DR9ccP8RjD7Aab2hKD3SewdP9bh5t76i7bjmPS1ba1sr4S4oskRp71.jpg" alt="" />
                    </Col>
                </Row>
            </div>
        </div>
