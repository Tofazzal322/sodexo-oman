                    ...
                    <Col className='' xs={12} md={5} lg={5} >
                        ...
                        <div className='salary-list p-4'>
                            ...
                            <Row className='salary-list  py-2'>
                                <Col className='tit'><strong>Location</strong></Col>
                                <Col> <strong>{job.location}</strong> </Col>
                            </Row>
                            <Row className='salary-list mt-2 py-2'>
                                <Col className='tit'><strong>Contact Type</strong></Col>
                                <Col> <strong>Fixed Term- {job.jobType}</strong> </Col>
                            </Row>
                            <Row className='salary-list mt-2 py-2'>
                                <Col className='tit'><strong>Job Category</strong></Col>
                                <Col> <strong>{job.category}</strong> </Col>
                            </Row>
                            <Row className='salary-list mt-2 py-2'>
                                <Col className='tit'><strong>Salary</strong></Col>
                                <Col> <strong>{job.salary}</strong> </Col>
                            </Row>
                          
                            <Row className='salary-list mt-2 py-2'>
                                <Col className='tit'><strong>Status</strong></Col>
                                <Col> <strong>{job.status}</strong> </Col>
                            </Row>
                            <Row className='salary-list mt-2 py-2'>
                                <Col className='tit'><strong>Apply Last Date</strong></Col>
                                <Col> <strong>{job.lastDate}</strong> </Col>
                            </Row>
                            <Row className='salary-list mt-2 py-2'>
                                <Col className='tit'><strong>Post On</strong></Col>
