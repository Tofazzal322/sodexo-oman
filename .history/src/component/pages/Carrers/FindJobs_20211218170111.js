          ...
          <Col md={8}>
            ...
            <div className="mt-3 job-div">
              ...
              <div className="text-align-right w-100 ">
                <p className="">  <span >Apply by 22 December, 2021</span> <FontAwesomeIcon icon={faCalendar} /><br /> <span className="me-2">Posted on 10 December, 2021</span> <FontAwesomeIcon icon={faCalendar} /></p>
