          ...
          <Col md={8}>
            ...
            <div className="mt-3 job-div">
              ...
              <div className="d-flex g-5 w-100 fw-bold mt-3">
                <div className="w-100">
                <p> <FontAwesomeIcon icon={faSearchLocation} /> <span>Al khuwair, Muscat, OMAN</span> <br /> <FontAwesomeIcon icon={faMoneyCheck} /> OMR  Monthly <br /> <FontAwesomeIcon icon={faClock} /> Fixed Term -Full Time </p>
