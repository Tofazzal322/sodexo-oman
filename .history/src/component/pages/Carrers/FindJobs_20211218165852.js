          ...
          <Col md={8}>
            ...
            <div className="mt-3 job-div">
              ...
              <div className="d-flex g-5 w-100 fw-bold mt-3">
                <div className="w-100">
                <p> <FontAwesomeIcon icon={faSearchLocation} /> Al khuwair, Muscat, OMAN <br /> <FontAwesomeIcon icon={faMoneyCheck} /> OMR  Monthly <br /> <FontAwesomeIcon icon={faC} /> Fixed Term -Full Time </p>
