                ...
                <Row className='container'>
                    ...
                    <Col className='' xs={12} md={5} lg={5} >
                        ...
                        <div className='salary-list p-4'>
                            ...
                            <Row className='salary-list'>
                                <Col><strong>Location</strong></Col>
                                <Col> <strong>{job.location}</strong> </Col>
                            </Row>
                            <Row className='salary-list mt-2 p-2'>
                                <Col><strong>Contact Type</strong></Col>
                                <Col> <strong>Fixed Term- {job.jobType}</strong> </Col>
                            </Row>
                            <Row className='salary-list mt-2'>
                            ...
                            <Row className='salary-list mt-2'>
                                <Col><strong>Apply Last Date</strong></Col>
                                <Col> <strong>{job.lastDate}</strong> </Col>
                            </Row>
                            <Row className='salary-list mt-2'>
                                <Col><strong>Post On</strong></Col>
