          ...
          <Col md={8}>
            ...
            <div className="mt-3 job-div">
              ...
              <div className="d-flex g-5 w-100 fw-bold mt-3">
                <div className="w-100">
                <p> <FontAwesomeIcon icon={faSearchLocation} /> <span className="ms-2"> Al khuwair, Muscat, OMAN </span> <br /> <FontAwesomeIcon icon={faMoneyCheck} /> <span className="">OMR  Monthly</span> <br /> <FontAwesomeIcon icon={faClock} /> <span className="ms-2">Fixed Term -Full Time</span> </p>
