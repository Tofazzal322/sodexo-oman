          ...
          <Col md={4}>
            ...
            <div className="login-section mb-5">
              <div className="login-register-btn">
                <Link className="login-register-btn mb-3" to="/login">
                  Login / Register
                </Link>
               
                          </div>
                           <p>
                  Join our community to receive real-time email and profile
                  alerts when a potential opportunity becomes available. You can
                  also search and apply for jobs and connect with like minded
                  people.
                </p>
            </div>
          </Col>
