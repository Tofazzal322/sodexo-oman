...
const FindJobs = () => {
  ...
  const coffee = <FontAwesomeIcon icon={["fal", "coffee"]} />
  return (
          ...
          <Col md={8}>
            ...
            <div className="mt-3 job-div">
              ...
              <div className="d-flex g-5 w-100 fw-bold mt-3">
                <div className="w-100">
                <p>  Al khuwair, Muscat, OMAN <br /> OMR  Monthly <br /> {coffee} Fixed Term -Full Time </p>
                <FontAwesomeIcon icon="check-square" />
    Your <FontAwesomeIcon icon="faLocationArrow" /> is hot and ready!
    Your <FontAwesomeIcon icon=",faTimes," /> is hot and ready!
    Your <FontAwesomeIcon icon="faDatabase" /> is hot and ready!
              </div>
