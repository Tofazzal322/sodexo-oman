...
const Footer = () => {
  return (
    <div className="bg-dark text-light">
     <Row></Row>
     <Row className="d-flex me-3 mb-5 mt-4 container"> <Col> <img src="https://uk.sodexo.com/files/live/sites/com-global/files/01%20Logo/DiversityInc-logo.png" alt="" /> </Col> 
