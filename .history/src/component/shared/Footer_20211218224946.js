...
const Footer = () => {
  return (
    <div className="footer-main-container ">
     ...
     <Row className="d-flex me-3 mb-5 mt-4 ms-5 container "> <Col> <img src="https://uk.sodexo.com/files/live/sites/com-global/files/01%20Logo/DiversityInc-logo.png" alt="" /> </Col> 
