...
const Footer = () => {
  return (
    <div >
     <Row></Row>
     <Row className="d-flex me-3 mb-5 mt-4 ms-5 footer"> <Col> <img src="https://uk.sodexo.com/files/live/sites/com-global/files/01%20Logo/DiversityInc-logo.png" alt="" /> </Col> 
