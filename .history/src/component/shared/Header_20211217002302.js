      ...
      <Container>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto ms-5">
            ...
            >
              <NavDropdown.Item>
                <Link className="text-decoration" to="Insights">
                  Insights
                </Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item>
                <Link className="text-decoration" to="CaseStudies">
                  Case Studies
                </Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
            ...
            <NavDropdown title="Careers" id="collasible-nav-dropdown">
              <NavDropdown.Item>
                <Link className="text-decoration" to="ReasonsToJoin">
                  Reasons to join
                </Link>
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item>
                <Link className="text-decoration" to="Career">
              ...
              <NavDropdown.Divider />
              <NavDropdown.Item>
                <Link className="text-decoration" to="CareersBlog">
                  Careers blogs
                </Link>
              </NavDropdown.Item>
            </NavDropdown>
