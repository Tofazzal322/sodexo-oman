...
const Header = () => {
  ...
  return (
    <Navbar collapseOnSelect expand="lg" bg="warning" variant="primary">
      <Container>
              <Navbar.Brand to="home">
                  <img src="https://uk.sodexo.com/files/live/sites/com-uk/files/About%20us/sodexo-logo.png" alt="" />
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto ">
            ...
            <NavDropdown className="text-light" title="Inspired thinking" id="collasible-nav-dropdown">
