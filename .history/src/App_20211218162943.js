...
import { faCheckSquare, faCoffee, faLocationArrow, faTimes } from '@fortawesome/free-solid-svg-icons'

library.add(fab, faCheckSquare, faCoffee, faLocationArrow,faTimes,date)
