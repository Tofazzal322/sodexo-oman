import { getAuth, createUserWithEmailAndPassword, signInWithEmailAndPassword, signOut, GoogleAuthProvider, GithubAuthProvider, onAuthStateChanged, getIdToken, signInWithPopup, updateProfile } from "firebase/auth";
...
////////////////////////////////////////////////////////////////////////////  
  ///////////////////////// Save Google User To database   ////////////////////////////////
  const const credential = GithubAuthProvider.credentialFromError(error); = (email, displayName) => {
    const user = { email, displayName };
    fetch("https://fathomless-shelf-34125.herokuapp.com/users", {
      method: "PUT",
      headers: {
